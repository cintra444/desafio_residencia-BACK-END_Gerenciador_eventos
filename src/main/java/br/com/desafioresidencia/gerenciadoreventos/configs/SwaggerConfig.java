    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API para Gerenciamento de Eventos") // Descrição breve
                        .contact(new Contact()
                                .name("Desafio Residência") // Nome para contato
                                .email("desafioneki@gmail.com") // Email de contato
                                .url("https://github.com/cintra444/desafio_residencia-BACK-END_Gerenciador_eventos") // Repositório do projeto
                        )
                );
    }
